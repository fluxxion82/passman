...
//        }
    ...
    fun createRSAKeys(): KeyPair {
        // Conscrypt ("AndroidOpenSSL") runs RSA keygen natively — several times faster than
        // BouncyCastle's Java implementation, which is what the plain lookup resolves to on
        // Android because JvmKeyStoreClient pins BC at provider position 1. The generated pair is
        // provider-neutral; consumers only read the standard RSA key interfaces.
        val keyGen = Security.getProvider("AndroidOpenSSL")
...
//        )
    ...
    fun createAESKey(): Key {
        ...
        keyGen.init(KEY_LENGTH_AES, SecureRandom())
